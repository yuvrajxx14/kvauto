...
UPDATE public.tractor_stock SET inspection_status='PASSED', pdi_status='PASSED', delivery_check_status='PASSED'
WHERE inspection_status <> 'PASSED' OR pdi_status <> 'PASSED' OR delivery_check_status <> 'PASSED';