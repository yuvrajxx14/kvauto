...
const STOCK_CLASS: Record<StockStatus, string> = {
  ...
  INSPECTION_PENDING: "bg-warning/15 text-warning-foreground border-warning/40",
  PDI_PENDING: "bg-warning/15 text-warning-foreground border-warning/40",
  INSPECTION_FAILED: "bg-destructive/10 text-destructive border-destructive/30",
